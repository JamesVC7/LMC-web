        ...
        <div class="sidebar_cont">
            ...
            <script>
                function validarFormulario() {
                    var idCategoria = document.getElementsByName("id_cat")[0].value;
                    var nombrePlato = document.getElementsByName("nombre_plato")[0].value;
                    ...
                    if (idCategoria === "" || nombrePlato === "" || precio === "" || cantidad === ""|| imagen === "") {
            ...
            <div class="div_contenido">
                ...
                <form class="form_agregar" action="controladorPlato" method="POST" enctype="multipart/form-data" onsubmit="return validarFormulario()">
                    <label>Id Categoria</label>
                    <input type="text" name="id_cat">
                    <label>Nombre</label>
