                            ...
                            <table class="table table-dark table-striped">
                                ...
                                <tbody>
                                    <%
                                        ...
                                        List<Cliente> list = clientdao.ListarCliente();
                                    ...
                                    %>
                                    <tr>
                                        <th scope="row"><%= client.getId_cliente()%></th>
                                        <td><%= client.getNombre()%></td>
                                        <td><%= client.getApellido()%></td>
                                        <td><%= client.getCelular()%></td>
                                        <td><%= client.getFecha_Nacimiento()%></td>
                                        <td><%= client.getDireccion()%></td>
                                        <td><%= client.getCorreo()%></td>
                                        <td><%= client.getClave()%></td>
                                        <td>
                                            <a href="controladorCliente?accion=editar&id=<%= client.getId_cliente()%>" class="btn btn-primary">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <a  href="controladorCliente?accion=eliminar&id=<%= client.getId_cliente()%>" class="btn btn-danger">
