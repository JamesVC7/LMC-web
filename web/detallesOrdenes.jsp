...
<html>
    ...
    <body>
        ...
        <div class="sidebar_cont">
            ...
            <% // Obtener el id_detalle seleccionado desde la URL
                String idDetalleSeleccionado = request.getParameter("id_detalle");

                if (idDetalleSeleccionado != null && !idDetalleSeleccionado.isEmpty()) {
                    int idDetalle = Integer.parseInt(idDetalleSeleccionado);
                    PedidoDAO pedidoDAO = new PedidoDAO();
                    List<Pedido> detallesPedido = pedidoDAO.listarDetallesPedidoPorIdDetalle(idDetalle);
            %>
            <div class="divCont">
                    ...
                    <div class="container mt-5">
                        <div class="table-responsive">
                            <table class="table table-dark table-striped">
                                ...
                                <tbody>
                                    <% for (Pedido detallePedido : detallesPedido) {%>
                                    <tr>
                                        <td><%= detallePedido.getId_plato()%></td>
                                        <td><%= detallePedido.getId_promo()%></td>
                                        <td><%= detallePedido.getNombre_plato()%></td>
                                        <td><%= detallePedido.getNombre_promo()%></td>
                                    </tr>
                                    <% } %>
                                </tbody>
                            </table>
                        ...
                        <a id="ver" href="dashboard_ordenes.jsp">Volver a Ordenes</a>
                    </div>
                </div>
            </div>
        </div>
